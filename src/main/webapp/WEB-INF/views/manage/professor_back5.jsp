            ...
            <ul class="nav navbar-nav">
                <li class="active">
                    <a href="${pageContext.request.contextPath}/professor/index"
                       style="padding-top: 20px; padding-bottom: 20px;"><i
                            class="menu-icon fa fa-laptop"></i>产品信息审核列表</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/toPage?url=professor_back2"
                       style="padding-top: 20px; padding-bottom: 20px;"><i class="menu-icon fa fa-glass"></i>模式审核列表</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/toPage?url=professor_back3"
                       style="padding-top: 20px; padding-bottom: 20px;"><i class="menu-icon fa fa-tasks"></i>基本信息</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/toPage?url=professor_back4"
                                                ...
                                                <div class="col col-md-5">
                                                    <div class="col-12 col-md-12">
                                                        <img class="card-img-top"
                                                             src="${pageContext.request.contextPath}/static/manage/res/2.png"
                                                             alt="Card image cap" id="sampleimg"
                                                             onclick="showbigpic(this)">
                                                    </div>
                                                    <div class="col-12 col-md-12">
                                                        <img class="card-img-top col-md-3"
                                                             src="${pageContext.request.contextPath}/static/manage/res/1.png"
                                                             alt="Card image cap" onclick="changeimg(this)">
                                                        <img class="card-img-top col-md-3"
                                                             src="${pageContext.request.contextPath}/static/manage/res/2.png"
                                                             alt="Card image cap" onclick="changeimg(this)">
                                                        <img class="card-img-top col-md-3"
                                                             src="${pageContext.request.contextPath}/static/manage/res/3.png"
                                                             alt="Card image cap" onclick="changeimg(this)">
                                                    </div>
