                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
								<div class="row form-group">
									<div class="col col-md-3 offset-md-2"><label for="originPwd" class=" form-control-label">原始密码</label></div>
									<div class="col-12 col-md-6"><input type="password" id="originPwd" name="password-input" placeholder="原始密码" class="form-control"></div>
								</div>
								<div class="row form-group">
									<div class="col col-md-3 offset-md-2"><label for="pwd" class=" form-control-label">新密码</label></div>
									<div class="col-12 col-md-6"><input type="password" id="pwd" name="password-input" placeholder="新密码" class="form-control"></div>
								</div>
								<div class="row form-group">
									<div class="col col-md-3 offset-md-2"><label for="confirmPwd" class=" form-control-label">确认密码</label></div>
									<div class="col-12 col-md-6"><input type="password" id="confirmPwd" name="password-input" placeholder="确认密码" class="form-control"></div>
								</div>
                                <hr>
    ...
    <script type="text/javascript">
        ...
        function updatePwd() {
            ...
            if(!data.get("originPwd")){show("初始密码不能为空！")}
                ...
                $.ajax({
                    url: "/toilet/professor/pwd/update",
                    type: "POST",
                    dataType: "json",
                    data: data,
                    async: false,
