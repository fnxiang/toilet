                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="card-text text-lg-center">
                                <button type="button" class="btn btn-outline-secondary" onclick="javascript:window.location.href='${pageContext.request.contextPath}/toPage?url=admin_back4'">确认分配</button>
                                <button type="button" class="btn btn-outline-secondary offset-md-2" onclick="javascript:window.location.href='${pageContext.request.contextPath}/toPage?url=admin_back4'">返回
                                </button>
                            </div>
