...
public class ParameterUtil {
    ...
    public static Map<String, String> resolveParams(HttpServletRequest request, String outputPath) throws Exception {
        ...
        String uploadPath = request.getServletContext().getRealPath(".")+ File.separator+outputPath+request.getSession().getAttribute("uId").toString()+File.separator;
            ...
            if(item.isFormField()) {
                ...
                if (item.getName() != null && fileNames.contains(item.getFieldName())) {
                    ...
                    if (!allowTypes.contains(type)) {
                        ...
                        String relativePath = outputPath + File.separator + request.getSession().getAttribute("uId").toString() + File.separator + filename;
